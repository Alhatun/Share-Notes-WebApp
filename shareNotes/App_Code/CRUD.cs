...
/// </summary>
/// 
namespace myClientApp.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["proConnectionString"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["proConnectionString"].ConnectionString);
        public CRUD()
        {
            //
